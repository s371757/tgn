...
class TemporalAttentionLayer(torch.nn.Module):
    ...
    def forward(self, src_node_features, src_time_features, neighbors_features,
        ...
        attn_mask = attn_mask.unsqueeze(1).repeat(self.n_head, 1, 1) # important, https://pytorch.org/docs/stable/generated/torch.nn.MultiheadAttention.html?highlight=multiheadattention#torch.nn.MultiheadAttention
        # attn_mask.shape: [N(600)*num_heads, L=1, S=10], N is batch size, L is fixed as 1, S is num of neighbor edges, set to 10 generally.
